...
export interface TblProductFindBaseAll extends RowDataPacket {
  ID_PRODUTO: number;
  SKU: number;
  PRODUTO: string;
...
export interface TblProductFindBaseSearch extends RowDataPacket {
  ID_PRODUTO: number;
  SKU: number;
  PRODUTO: string;
  ESTOQUE_LOJA: number;
...
export interface TblProductFindBaseId extends RowDataPacket {
  ID_PRODUTO: number;
  SKU: number;
  PRODUTO: string;
  DESCRICAO_TAB: string;
...
export type SpResultProductFindBaseIdV3Data = [
  TblProductFindBaseId[],
  SpDefaultFeedback[],
