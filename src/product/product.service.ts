...
export class ProductService {
  ...
  async tskProductUpdPathImageV2(dataJsonDto: ProductUpdPathImageDto) {
    try {
      const queryString = updPathImageProductQuery(dataJsonDto);
  ...
  async tskProductUpdMetadataV2(dataJsonDto: ProductUpdMetadataDto) {
    try {
      const queryString = ProductUpdMetadataQuery(dataJsonDto);
