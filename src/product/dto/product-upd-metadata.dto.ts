...
export class ProductUpdMetadataDto extends EndpointContextDto {
  ...
  @ApiProperty({
    ...
    maxLength: 200,
    example: 'This is a meta description for the product',
  })
  @IsNotEmpty()
  @IsString()
...
Sample JSON for testing:
{
  ...
  "pe_meta_description": "This is a meta description for the product"
