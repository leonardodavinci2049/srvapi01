...
export class SupplierController {
  ...
  @UseGuards(AuthGuard)
  @Post('v2/supplier-find-manager-id')
  supplierFindManagerIdV2(@Body() dataJsonDto: SupplierFindManagerIdV2Dto) {
    return this.supplierService.taskSupplierFindManagerIdV2(dataJsonDto);
  }
