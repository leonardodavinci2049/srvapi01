...
export class CarrierFindManagerAllV2Dto extends EndpointContextDto {
  @ApiProperty({ description: 'Search term', maxLength: 100 })
  @IsString()
  pe_search!: string;
  ...
  @ApiProperty({
    description: 'Column ID (1 = name, 2 = carrier ID)',
  })
  @IsNumber()
  pe_column_id!: number;
