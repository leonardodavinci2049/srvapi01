...
export function ProductUpdInlShortDescriptionV3Query(
  ...
  const olDescricaoCurta = dataJsonDto.pe_descricao_curta;

  const queryString = ` call sp_product_upd_inl_Short_description_v3(
        ${olAppId},
        ${olSystemClientId},
        ${olStoreId},
        '${olOrganizationId}',
